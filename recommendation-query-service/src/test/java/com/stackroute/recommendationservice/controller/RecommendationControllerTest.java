...
//        when(recommendationService.getDocumentByQuestionId(TEST_QUESTION)).thenReturn(QUESTION_DOCUMENT_ONE);
...
//        when(recommendationService.getDocumentByQuestionId(TEST_QUESTION)).thenReturn(null);
//        mockMvc.perform(MockMvcRequestBuilders.get("/member/trending?username=USERNAME")
//                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(QUESTION_NODE_ONE)))
//                .andExpect(MockMvcResultMatchers.status().isOk())
//                .andDo(MockMvcResultHandlers.print());
...
//        when(recommendationService.getTrendingQuestionsForRegisteredUser(USERNAME)).thenReturn(Collections.singletonList(QUESTION_NODE_ONE));
//        when(recommendationService.getDocumentByQuestionId(TEST_QUESTION)).thenReturn(QUESTION_DOCUMENT_TWO);
//        mockMvc.perform(MockMvcRequestBuilders.get("/member/trending?username=USERNAME")
//                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(QUESTION_NODE_ONE)))
//                .andExpect(MockMvcResultMatchers.status().isOk())
//                .andDo(MockMvcResultHandlers.print());
...
//        mockMvc.perform(MockMvcRequestBuilders.post("/member/notify", QuestionDTO.builder().action(Actions.POST_QUESTION).answer(Collections.emptyList()).comment(Collections.emptyList()).description("").question(TEST_QUESTION).questionId(0).user(User.builder().email(USERNAME).build()).build())
...
//        mockMvc.perform(MockMvcRequestBuilders.post("/member/notify")
//                .contentType(MediaType.APPLICATION_JSON).content(asJsonString(USER_NODE)))
//                .andExpect(MockMvcResultMatchers.status().isOk())
//                .andDo(MockMvcResultHandlers.print());
//    }
